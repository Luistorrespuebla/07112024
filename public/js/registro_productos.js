    ...
    .then((respuesta) => {
        ...
        contenido += `
            <tr>
                ...
                <td>${dato['cantidad']}</td>
                <td>
                    <button class="btn btn-primary me-3 editar" data-btn="editar" data-id="${dato['id_producto']}" data-nombre="${dato['producto']}" data-precio="${dato['precio']}" data-cantidad="${dato['cantidad']}">
                        Editar
        ...
        $('#myTable').DataTable({
            language:{url:"public/json/languaje.json"}
        });
    });
}
